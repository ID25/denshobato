...
### <a name="chat"></a>Built-in Chat Panel
![alt text](http://i.imgur.com/0sUUfDl.jpg "Screen")
Denshobato provides this simple chat panel for you. If you don't need any special customization for dialog panel, or if you want to try messaging quickly, you can use chat panel.
